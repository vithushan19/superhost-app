    ...
    <div className={styles.container}>
      ...
      <main className="flex flex-col items-center py-6 h-screen">
        ...
        { events.length > 0 && <div className="my-5">
          {events.map((event, id) => {
            return (<a key={id} href={`events/${id}`} className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-4">
