...
const Confirmation = () => {
  ...
  return (
    <>
      ...
      <InvitationCard title={title} imageURL={imageURL} message={eventMessage} location={eventLocation} startDate={startDate} endDate={endDate} primaryButton={<CreateEventButton />} secondaryButton={<MakeChangesButton/>} background={selectedBg} />
    </>
  )
}
